<template>
  <div
    class="flex flex-col items-center w-40 h-full overflow-hidden text-gray-700 bg-gray-100 rounded border"
  >
    <a
      class="flex items-center w-full p-3 hover:bg-gray-200"
    ...
    <div class="w-full px-2">
      <div class="flex flex-col items-center w-full border-t border-gray-300">
        ...
        <router-link
          to="/time"
          class="flex items-center w-full h-12 px-3 mt-2 hover:bg-gray-300 rounded"
        >
          <svg
            class="w-6 h-6 stroke-current"
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span class="ml-2 text-sm font-medium">Time</span>
        </router-link>
        <router-link
          to="/about"
          class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300"
    ...
    >
      ...
      <span class="ml-2 text-sm font-medium">{{
        timeTrackerStore.currentUser.attributes?.first_name
      }}</span>
    </a>
  </div>
</template>
